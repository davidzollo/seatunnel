...
public class TableDiscoveryUtils {
    ...
    public static List<TableId> listTables(JdbcConnection jdbc, RelationalTableFilters tableFilters)
        ...
        // READ TABLE NAMES
        // ----------------
        // The target database name becomes part of the catalog-qualified INFORMATION_SCHEMA path,
        // so we need to build the SQL string per database. This is safe here because the database
        // names come from pg_database rather than user input.
