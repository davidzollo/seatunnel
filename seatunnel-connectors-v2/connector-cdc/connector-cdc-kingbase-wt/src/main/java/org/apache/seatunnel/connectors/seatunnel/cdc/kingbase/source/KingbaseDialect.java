...
public class KingbaseDialect implements JdbcDataSourceDialect {
    ...
    private transient KingbaseSchema postgresSchema;
    ...
    public List<TableId> discoverDataCollections(JdbcSourceConfig sourceConfig) {
        KingbaseSourceConfig postgresSourceConfig = (KingbaseSourceConfig) sourceConfig;
    ...
    public TableChanges.TableChange queryTableSchema(JdbcConnection jdbc, TableId tableId) {
        if (postgresSchema == null) {
            postgresSchema = new KingbaseSchema(sourceConfig.getDbzConnectorConfig(), tableMap);
        }
