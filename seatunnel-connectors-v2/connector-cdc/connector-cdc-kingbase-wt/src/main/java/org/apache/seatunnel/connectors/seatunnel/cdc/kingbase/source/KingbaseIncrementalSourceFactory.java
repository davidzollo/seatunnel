...
public class KingbaseIncrementalSourceFactory implements TableSourceFactory {
    ...
    public <T, SplitT extends SourceSplit, StateT extends Serializable>
        ...
        return () -> {
            ...
            // Keep the catalog JDBC URL exactly as the datasource layer validated it. Kingbase V8
            // can authenticate differently once transport flags are rewritten, while Debezium's
            // secondary JDBC connections are already normalized in KingbaseSourceConfigFactory.
