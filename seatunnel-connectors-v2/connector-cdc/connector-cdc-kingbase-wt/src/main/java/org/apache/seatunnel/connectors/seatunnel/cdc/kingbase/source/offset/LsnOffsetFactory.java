...
package org.apache.seatunnel.connectors.seatunnel.cdc.kingbase.source.offset;
...
import org.apache.seatunnel.connectors.seatunnel.cdc.kingbase.source.KingbaseDialect;
import org.apache.seatunnel.connectors.seatunnel.cdc.kingbase.utils.KingbaseUtils;

import io.debezium.connector.kingbase.SourceInfo;
...
public class LsnOffsetFactory extends OffsetFactory {
    ...
    private final KingbaseDialect dialect;

    public LsnOffsetFactory(KingbaseSourceConfigFactory configFactory, KingbaseDialect dialect) {
    ...
    public Offset latest() {
        try (JdbcConnection jdbcConnection = dialect.openJdbcConnection(sourceConfig)) {
            return KingbaseUtils.currentLsn((KingbaseConnection) jdbcConnection);
        } catch (Exception e) {
