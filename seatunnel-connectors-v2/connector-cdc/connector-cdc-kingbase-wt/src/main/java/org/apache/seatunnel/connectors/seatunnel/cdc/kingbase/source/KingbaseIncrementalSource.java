...
import org.apache.seatunnel.connectors.seatunnel.cdc.kingbase.source.offset.LsnOffsetFactory;
import org.apache.seatunnel.connectors.seatunnel.cdc.kingbase.utils.KingbaseDebeziumDeserializationConverterFactory;
...
public class KingbaseIncrementalSource<T> extends IncrementalSource<T, JdbcSourceConfig>
        implements SupportParallelism, SupportColumnProjection {

    static final String IDENTIFIER = "Kingbase-CDC";

    public KingbaseIncrementalSource(ReadonlyConfig options, List<CatalogTable> catalogTables) {
    ...
    public Option<StartupMode> getStartupModeOption() {
        return KingbaseSourceOptions.STARTUP_MODE;
    }

    @Override
    public Option<StopMode> getStopModeOption() {
        return KingbaseSourceOptions.STOP_MODE;
    }

    @Override
    public SourceConfig.Factory<JdbcSourceConfig> createSourceConfigFactory(ReadonlyConfig config) {
        KingbaseSourceConfigFactory configFactory = new KingbaseSourceConfigFactory();
        ...
        return (DebeziumDeserializationSchema<T>)
                SeaTunnelRowDebeziumDeserializeSchema.builder()
                        ...
                        .setUserDefinedConverterFactory(
                                KingbaseDebeziumDeserializationConverterFactory.INSTANCE)
    ...
    public DataSourceDialect<JdbcSourceConfig> createDataSourceDialect(ReadonlyConfig config) {
        return new KingbaseDialect((KingbaseSourceConfigFactory) configFactory, catalogTables);
    }

    @Override
    public OffsetFactory createOffsetFactory(ReadonlyConfig config) {
        return new LsnOffsetFactory(
                (KingbaseSourceConfigFactory) configFactory, (KingbaseDialect) dataSourceDialect);
    }
    ...
    private Map<TableId, Struct> tableChanges() {
        ...
        KingbaseDialect dialect =
                new KingbaseDialect((KingbaseSourceConfigFactory) configFactory, catalogTables);
