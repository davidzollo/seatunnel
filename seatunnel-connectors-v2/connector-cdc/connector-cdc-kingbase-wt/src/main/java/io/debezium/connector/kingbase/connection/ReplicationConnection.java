...
public interface ReplicationConnection extends AutoCloseable {
     ...
     * connections.
     *
     * @param config a {@link KingbaseConnectorConfig} instance; may not be null
     * @return a builder, never null
     */
    static Builder builder(KingbaseConnectorConfig config) {
        return new KingbaseReplicationConnection.ReplicationConnectionBuilder(config);
    }
    ...
    interface Builder {
        ...
        Builder withPublicationAutocreateMode(
                final KingbaseConnectorConfig.AutoCreateMode publicationAutocreateMode);
         ...
         */
        Builder withPlugin(final KingbaseConnectorConfig.LogicalDecoder plugin);
         ...
         * @return this instance
         */
        Builder withSchema(KingbaseSchema schema);
