...
public class KingbaseDataEventsParam {
    ...
    public KingbaseDataEventsParam(
            ...
            RelationalSnapshotChangeEventSource.RelationalSnapshotContext<KingbaseOffsetContext>
                    snapshotContext,
     ...
     */
    public RelationalSnapshotChangeEventSource.RelationalSnapshotContext<KingbaseOffsetContext>
            getSnapshotContext() {
