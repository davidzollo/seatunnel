...
class Wal2JsonReplicationMessage implements ReplicationMessage {
    ...
    private List<Column> transform(
        ...
        for (int i = 0; i < columnNames.size(); i++) {
            ...
            final KingbaseType columnType = typeRegistry.get(parseType(columnName, columnTypeName));
     ...
     * necessary by the {@link KingbaseValueConverter#converter(Column, Field)} instance to match
