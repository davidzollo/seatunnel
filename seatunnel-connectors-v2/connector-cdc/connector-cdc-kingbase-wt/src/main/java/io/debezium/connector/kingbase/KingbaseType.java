 ...
 */
public class KingbaseType {

    public static final KingbaseType UNKNOWN =
            new KingbaseType("unknown", -1, Integer.MIN_VALUE, null, null, null, null);

    private final String name;
    private final int oid;
    private final int jdbcId;
    private final KingbaseType parentType;
    private final KingbaseType elementType;
    private final TypeInfo typeInfo;
    private final int modifiers;
    private final List<String> enumValues;

    private KingbaseType(
            String name,
            int oid,
            int jdbcId,
            TypeInfo typeInfo,
            List<String> enumValues,
            KingbaseType parentType,
    ...
    /** @return Kingbase OID of this type */
    public int getOid() {
        return oid;
    }
    ...
    public boolean equals(Object obj) {
        ...
        KingbaseType other = (KingbaseType) obj;
        if (oid != other.oid) {
            return false;
        }
        return true;
    ...
    public static class Builder {
        ...
        public KingbaseType build() {
            KingbaseType parentType = null;
            if (this.hasParentType()) {
                parentType = typeRegistry.get(parentTypeOid);
            }

            KingbaseType elementType = null;
            if (elementTypeOid != 0) {
                elementType = typeRegistry.get(elementTypeOid);
            }

            return new KingbaseType(
