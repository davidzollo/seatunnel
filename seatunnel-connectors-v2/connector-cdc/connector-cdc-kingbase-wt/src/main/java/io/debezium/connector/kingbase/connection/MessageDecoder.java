...
public interface MessageDecoder {
     ...
     * messages CAN contain type metadata. See Kingbase command START_REPLICATION SLOT for more
     * details.
     *
     * @param builder
    ...
    /**
     * Allows MessageDecoder to configure options with which the replication stream is started. The
     * messages MUST NOT contain type metadata. See Kingbase command START_REPLICATION SLOT for more
     * details.
     *
     * @param builder
     * @return the builder instance
