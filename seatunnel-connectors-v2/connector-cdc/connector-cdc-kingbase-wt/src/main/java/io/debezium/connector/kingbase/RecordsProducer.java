...
public abstract class RecordsProducer {
    ...
    protected final KingbaseTaskContext taskContext;
    protected final SourceInfo sourceInfo;

    protected RecordsProducer(KingbaseTaskContext taskContext, SourceInfo sourceInfo) {
    ...
    /**
     * Starts up this producer. This is normally done by a {@link KingbaseConnectorTask} instance.
     ...
     * KingbaseConnectorTask} instance
     */
