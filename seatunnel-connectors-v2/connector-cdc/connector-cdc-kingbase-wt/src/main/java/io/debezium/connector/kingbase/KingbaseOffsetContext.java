...
import io.debezium.connector.kingbase.utils.SignalBasedIncrementalSnapshotContext;
...
public class KingbaseOffsetContext implements OffsetContext {
    ...
    public static class Loader implements OffsetContext.Loader<KingbaseOffsetContext> {

        private final KingbaseConnectorConfig connectorConfig;

        public Loader(KingbaseConnectorConfig connectorConfig) {
        ...
        @Override
        public KingbaseOffsetContext load(Map<String, ?> offset) {
            ...
            return new KingbaseOffsetContext(
                    connectorConfig,
                    lsn,
    ...
    public String toString() {
        return "KingbaseOffsetContext [sourceInfoSchema="
                + sourceInfoSchema
                + ", sourceInfo="
                + sourceInfo
                + ", lastSnapshotRecord="
    ...
    public static KingbaseOffsetContext initialContext(
            KingbaseConnectorConfig connectorConfig,
