...
import io.debezium.connector.kingbase.utils.CloudEventsProvider;
 ...
 */
public class KingbaseCloudEventsProvider implements CloudEventsProvider {
    @Override
    ...
    public RecordParser createParser(Schema schema, Struct record) {
        return new KingbaseRecordParser(schema, record);
    }
