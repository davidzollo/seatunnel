...
import io.debezium.connector.kingbase.utils.DefaultValueConverter;
...
@ThreadSafe
public class KingbaseDefaultValueConverter implements DefaultValueConverter {

    private static Logger LOGGER = LoggerFactory.getLogger(KingbaseDefaultValueConverter.class);
    ...
    public KingbaseDefaultValueConverter(
            KingbaseValueConverter valueConverters, TimestampUtils timestampUtils) {
    ...
    private static Map<String, DefaultValueMapper> createDefaultValueMappers(
        ...
        result.put(
                "timestamp",
                (c, v) -> timestampUtils.toLocalDateTime(extractDefault(v, "1970-01-01")));
        result.put(
                "timestamptz",
                (c, v) -> timestampUtils.toTimestamp(null, extractDefault(v, "1970-01-01")));
        result.put("interval", (c, v) -> extractDefault(v, "epoch"));
