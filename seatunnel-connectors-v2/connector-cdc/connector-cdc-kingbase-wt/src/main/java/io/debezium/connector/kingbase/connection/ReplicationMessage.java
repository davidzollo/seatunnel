...
/**
 * An abstract representation of a replication message that is sent by a Kingbase logical decoding
 * plugin and is processed by the Debezium Kingbase connector.
 *
...
public interface ReplicationMessage {
    ...
    public interface Column {
        ...
        Object getValue(
                final KingbaseStreamingChangeEventSource.PgConnectionSupplier connection,
    ...
    public interface ColumnValue<T> {
        ...
        boolean isArray(KingbaseType type);
     ...
     * MessageDecoder}. Enables {@link KingbaseStreamingChangeEventSource} to advance LSN forward
