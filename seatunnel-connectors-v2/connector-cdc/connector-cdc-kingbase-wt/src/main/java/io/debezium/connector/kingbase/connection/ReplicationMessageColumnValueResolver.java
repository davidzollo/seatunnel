...
public class ReplicationMessageColumnValueResolver {
    ...
    public static Object resolveValue(
        ...
        switch (type.getName()) {
            ...
            case "date":
                // Kingbase decoderbufs reports DATE as a root type, while older HighGo paths can
                // report it as TIMESTAMP with fullType=date.
            ...
            case "money":
                ...
                return (v instanceof KBmoney) ? KingbaseMoneyUtil.numericValue((KBmoney) v) : v;
            case "path":
                return value.asPath();
            case "point":
