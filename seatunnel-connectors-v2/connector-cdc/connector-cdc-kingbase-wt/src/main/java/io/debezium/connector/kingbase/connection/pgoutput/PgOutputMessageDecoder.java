...
public class PgOutputMessageDecoder extends AbstractMessageDecoder {
    ...
    private KingbaseConnection connection;
        ...
        switch (messageType) {
            ...
            case TRUNCATE:
                if (decoderContext.getConfig().truncateHandlingMode()
                        == KingbaseConnectorConfig.TruncateHandlingMode.INCLUDE) {
    ...
    private void handleRelationMessage(ByteBuffer buffer, TypeRegistry typeRegistry)
        ...
        for (short i = 0; i < columnCount; ++i) {
            ...
            final KingbaseType postgresType = typeRegistry.get(columnType);
            boolean key =
    ...
    private List<io.debezium.relational.Column> getTableColumnsFromDatabase(
            KingbaseConnection connection, DatabaseMetaData databaseMetadata, TableId tableId)
            throws SQLException {
    ...
    private static List<ReplicationMessage.Column> resolveColumnsFromStreamTupleData(
        ...
        for (short i = 0; i < numberOfColumns; ++i) {
            ...
            final KingbaseType columnType = typeRegistry.get(typeName);
                ...
                columns.add(
                        new AbstractReplicationMessageColumn(
                            ...
                            public Object getValue(
                                    KingbaseStreamingChangeEventSource.KingbaseConnectionSupplier
                                            connection,
