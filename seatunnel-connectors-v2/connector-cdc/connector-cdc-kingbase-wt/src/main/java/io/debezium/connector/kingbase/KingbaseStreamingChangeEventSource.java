...
public class KingbaseStreamingChangeEventSource
        implements StreamingChangeEventSource<KingbasePartition, KingbaseOffsetContext> {
    ...
    private void commitMessage(
            KingbasePartition partition, KingbaseOffsetContext offsetContext, final Lsn lsn)
            throws SQLException, InterruptedException {
        lastCompletelyProcessedLsn = lsn;
