...
/**
 * Abstraction of Kingbase log sequence number, adapted from {@link
 * com.kingbase8.replication.LogSequenceNumber}.
 *
...
public class Lsn implements Comparable<Lsn> {
    ...
    /**
     * @param value Kingbase JDBC driver domain type representing position in the write-ahead log
     *     stream
     * @return not null LSN instance
     */
    ...
    /** @return Kingbase JDBC driver representation of position in the write-ahead log stream */
