...
public abstract class AbstractReplicationMessageColumn implements ReplicationMessage.Column {
    ...
    public static class TypeMetadataImpl implements ReplicationMessage.ColumnTypeMetadata {
        ...
        public TypeMetadataImpl(
                String columnName, KingbaseType type, String typeWithModifiers, boolean optional) {
    ...
    private final KingbaseType type;
    ...
    /** @return the {@link KingbaseType} containing both OID and JDBC id. */
    @Override
    public KingbaseType getType() {
        return type;
    }
