...
public class LogicalDecodingMessageMonitor {
    ...
    public LogicalDecodingMessageMonitor(
            KingbaseConnectorConfig connectorConfig, BlockingConsumer<SourceRecord> sender) {
                ...
                SchemaBuilder.struct()
                        .name(
                                schemaNameAdjuster.adjust(
                                        "io.debezium.connector.kingbase.MessageKey"))
                        .field(
        ...
        this.blockSchema =
                SchemaBuilder.struct()
                        .name(schemaNameAdjuster.adjust("io.debezium.connector.kingbase.Message"))
                        .field(
                                DEBEZIUM_LOGICAL_DECODING_MESSAGE_PREFIX_KEY,
                                Schema.OPTIONAL_STRING_SCHEMA)
                        .field(
        ...
        this.valueSchema =
                SchemaBuilder.struct()
                        .name(
                                schemaNameAdjuster.adjust(
                                        "io.debezium.connector.kingbase.MessageValue"))
