...
package org.apache.seatunnel.connectors.seatunnel.snowflakefile.sink.savemode;
    ...
    protected void createSchemaWhenNotExist() {
        ...
        if (tempTablePath != null && tempCatalogTable != null) {
            if (!catalog.tableExists(tempTablePath)) {
                catalog.createTable(tempTablePath, tempCatalogTable, true);
            }
        }
    }
}
