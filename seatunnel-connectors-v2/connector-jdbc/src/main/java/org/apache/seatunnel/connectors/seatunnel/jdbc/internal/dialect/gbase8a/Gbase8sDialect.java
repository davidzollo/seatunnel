...
import org.apache.seatunnel.connectors.seatunnel.jdbc.internal.dialect.informix.InformixDialect;
...
public class Gbase8sDialect extends InformixDialect {
    @Override
    ...
    public JdbcDialectTypeMapper getJdbcDialectTypeMapper() {
        return new Gbase8sTypeMapper();
    }

    @Override
    public TablePath parse(String tablePath) {
        TablePath path = TablePath.of(tablePath, false);
        return TablePath.of(path.getDatabaseName(), path.getTableName().toUpperCase());
    }
    ...
    public String tableIdentifier(TablePath tablePath) {
        ...
        return String.format(
                "%s.%s", tablePath.getDatabaseName(), tablePath.getTableName().toUpperCase());
    }

    @Override
    public String tableIdentifier(String database, String tableName) {
        return quoteDatabaseIdentifier(database) + "." + quoteIdentifier(tableName.toUpperCase());
    }
