...
public class DBFExploder {
    ...
    private static byte[] ChBits = {
        ,
        ...
        0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C,
                0x0C,
        0x0D, 0x0C, 0x0D, 0x0D, 0x0D, 0x0C, 0x0D, 0x0D, 0x0D, 0x0C, 0x0D, 0x0D, 0x0D, 0x0D, 0x0C,
                0x0D,
        0x0D, 0x0D, 0x0C, 0x0C, 0x0C, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D, 0x0D,
                0x0D
    };

    // Bit sequences used to represent the base values of the copy length
    private static byte[] LenCode = {
        0x05, 0x03, 0x01, 0x06, 0x0A, 0x02, 0x0C, 0x14, 0x04, 0x18, 0x08, 0x30, 0x10, 0x20, 0x40,
        0x00
    };

    // Lengths of bit sequences used to represent the base values of the copy length
    private static byte[] LenBits = {
        0x03, 0x02, 0x03, 0x03, 0x04, 0x04, 0x04, 0x05, 0x05, 0x05, 0x05, 0x06, 0x06, 0x06, 0x07,
        0x07
    };
    ...
    private static byte[] OffsBits = {
        0x02, 0x04, 0x04, 0x05, 0x05, 0x05, 0x05, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06,
                0x06,
    ...
    public static int pkexplode(byte[] pInBuffer, DBFStorage out, int outSize) throws IOException {
        ...
        if (4 > nDictSizeByte || nDictSizeByte > 6)
            throw new IllegalArgumentException(
                    "PK_ERR_BAD_DATA: Invalid DictSizeByte: " + nDictSizeByte);
            ...
            if ((nBitBuffer & 1) != 0) {
                        ...
                        (int)
                                ((LenBase[i] & 0xFFFF)
                                        + TRUNCATE_VALUE(
                                                nBitBuffer,
                                                ExLenBits[i]
                                                        & 0xFF)); // Length of data to copy from the
                // dictionary
                ...
                while (nBits < 14) {
                    ...
                    if (pInPos >= pInBuffer.length) {
                        ...
                        // nOutSize = pOutPos - pOutBuffer;
                        throw new IllegalArgumentException(
                                "PK_ERR_INCOMPLETE_INPUT: Incomplete input");
                    }
                    ...
                    pCopyOffs =
                            (int)
                                    (pDictPos
                                            - 1
                                            - ((i << nDictSizeByte)
                                                    + TRUNCATE_VALUE(nBitBuffer, nDictSizeByte)));
                ...
                while (nCopyLen-- > 0) {
                    ...
                    if (pOutPos >= outSize)
                        throw new IllegalArgumentException(
                                "PK_ERR_BUFFER_TOO_SMALL: Output buffer is full: "
                                        + pOutPos
                                        + " / "
                                        + outSize);
