...
public final class DBFUtils {
        ...
        if (t_float.length > 0
            ...
            try {
                ...
                throw new DBFException(
                        "Failed to parse Float value [" + aux + "] : " + e.getMessage(), e);
            }
        } else {
            return null;
        }
    ...
    public static byte[] doubleFormating(
        ...
        return textPadding(df.format(num), charset, fieldLength, DBFAlignment.RIGHT, (byte) ' ');
    }
    ...
    /**
     * Closes silently a #{@link Closeable}. it can be null or throws an exception, will be ignored.
     *
