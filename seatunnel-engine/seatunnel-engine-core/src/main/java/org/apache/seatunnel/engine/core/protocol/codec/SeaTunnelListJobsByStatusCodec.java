...
@Generated("59ac0bcef9ccf7fe711b0b17dc90a394")
public final class SeaTunnelListJobsByStatusCodec {
    // hex: 0xDE1200
    public static final int REQUEST_MESSAGE_TYPE = 14553600;
    // hex: 0xDE1201
    public static final int RESPONSE_MESSAGE_TYPE = 14553601;
    ...
    private SeaTunnelListJobsByStatusCodec() {}

    public static ClientMessage encodeRequest(java.lang.String jobStatus) {
        ClientMessage clientMessage = ClientMessage.createForEncode();
        clientMessage.setRetryable(true);
        clientMessage.setOperationName("SeaTunnel.ListJobsByStatus");
        ...
        StringCodec.encode(clientMessage, jobStatus);
