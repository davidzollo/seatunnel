...
/** Test for {@link ConnectorCheckCommand}. */
public class ConnectorCheckCommandTest {

    @Test
    public void testConnectorCheckCommandList() {
        String[] args = new String[] {"-l"};
        extracted(args);
    }

    @Test
    public void testConnectorPrintRelatedSourceOrSinkOptions() {
    ...
    @Test
    public void testConnectorCheckCommandPrintAllOptionsForFakesource() {
        String[] args = {"-o", "Fakesource"};
